...
class HotelForm(forms.Form) :
    ...
    name = forms.CharField(label='Hotel Name', max_length=50, widget=forms.TextInput(attrs=common_attrs('name','Enter your hotel name')))
    nick_name = forms.CharField(label='Hotel Nick Name', max_length=50, widget=forms.TextInput(attrs=common_attrs('nick_name','Enter your hotel nick name')))
    about = forms.CharField(label='About', max_length=50, required=False,widget=forms.TextInput(attrs=common_attrs('about','Enter your about hotel')))
